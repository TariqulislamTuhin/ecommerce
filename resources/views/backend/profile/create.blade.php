                ...
                <form method="POST" action="{{ route('profile.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input @if (!empty($profile) && $profile->gender == 'male') checked @endif type="radio"
                                class="mr-3 @error('gender')
                        is-invalid @enderror" id="male"
                                name="gender" value="male">
                            <label for="female">Female</label>
                            <input @if (!empty($profile) && $profile->gender == 'female') checked @endif type="radio"
                                class="@error('gender')
                        is-invalid @enderror" id="female"
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control @error('mobile_no') is-invalid @enderror"
                                id="mobile_no" placeholder="017XXXXXXXX" name="mobile_no"
